package br.com.musicist.modules.framework.auth.service;
...
import br.com.musicist.modules.framework.auth.dto.LoginRequest;
import br.com.musicist.modules.framework.auth.dto.LoginResponse;
import br.com.musicist.modules.framework.auth.dto.RegisterRequest;
import br.com.musicist.modules.framework.auth.dto.RegisterResponse;
import br.com.musicist.modules.framework.auth.exceptions.UserAlreadyExistsException;
import br.com.musicist.modules.framework.auth.exceptions.UserNotFoundException;
import br.com.musicist.modules.framework.auth.exceptions.WrongPasswordException;
...
import br.com.musicist.modules.musicist.profile.MusicProfileRepository;
