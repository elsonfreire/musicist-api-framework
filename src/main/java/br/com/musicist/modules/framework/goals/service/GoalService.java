package br.com.musicist.modules.framework.goals.service;
...
import br.com.musicist.modules.framework.goals.dto.GoalResponse;
import br.com.musicist.modules.framework.goals.dto.GoalUpdateRequest;
import br.com.musicist.modules.framework.goals.enums.GoalStatusType;
import br.com.musicist.modules.framework.goals.exceptions.ActiveGoalsException;
import br.com.musicist.modules.framework.goals.exceptions.GoalAlreadyResolvedException;
import br.com.musicist.modules.framework.goals.exceptions.GoalNotFoundException;
import br.com.musicist.modules.framework.goals.exceptions.InvalidGoalStatusTransition;
import br.com.musicist.modules.framework.goals.model.Goal;
import br.com.musicist.modules.framework.goals.repository.GoalRepository;
